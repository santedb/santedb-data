...
namespace SanteDB.Persistence.Data.Services.Persistence
{
        ...
        where TDbModel : class, IDbIdentified, new()
    {
            ...
            where TModelAssociation : IdentifiedData, ISimpleAssociation, new()
        {
            ...
            var existing = data.BatchOperation == Core.Model.DataTypes.BatchOperationType.Update ? persistenceService.Query(context, o => o.SourceEntityKey == data.Key || existingKeys.Contains(o.Key)).Select(o => o.Key).ToArray() : new Guid?[0];
            ...
            var updatedRelationships = associations.Where(o => !o.IsEmpty() && o.BatchOperation != Core.Model.DataTypes.BatchOperationType.Delete && o.Key.HasValue && existing.Any(a => a == o.Key)).Select(a =>
            {
