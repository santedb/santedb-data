...
--#!
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_PROV_ID) VALUES (char_to_uuid('5fb731bf-4e59-4863-80bd-51757d58ea9a'), '1.3.6.1.4.1.33349.3.1.5.9.2.2.4', 'Export Clinical Data (PHI)', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
--#!
...
CREATE TABLE SEC_SES_TBL (
	...
	RFRSH_EXP_UTC TIMESTAMP, -- THE TIME THAT THE REFRESH TOKEN EXPIRES
