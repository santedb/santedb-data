/** 
 * <feature scope="SanteDB.Persistence.Data" id="20250407-01" name="Update:20250407-01"   invariantName="FirebirdSQL" >
 *	<summary>Update: Add notification and notification template tables</summary>
 *	<isInstalled>select ck_patch('20250407-01') from rdb$database</isInstalled>
 * </feature>
 */
CREATE TABLE nfn_tpl_tbl (
    ...
    obslt_utc TIMESTAMP,
    obslt_prov_id UUID,
    CONSTRAINT pk_nfn_tpl_tbl PRIMARY KEY (tpl_id),
...
CREATE TABLE nfn_tpl_cnt_tbl (
    tpl_cnt_id UUID NOT NULL,
    nfn_tpl_id UUID,
    lang_cs VARCHAR(2),
    sbj BLOB SUB_TYPE TEXT,
    bdy BLOB SUB_TYPE TEXT NOT NULL,
    CONSTRAINT pk_nfn_tpl_cnt_tbl PRIMARY KEY (tpl_cnt_id),
    CONSTRAINT fk_tpl_id_tpl_tbl FOREIGN KEY (nfn_tpl_id) REFERENCES nfn_tpl_tbl(tpl_id)
);
CREATE TABLE nfn_tpl_prm_tbl (
    tpl_prm_id UUID NOT NULL,
    nfn_tpl_id UUID,
    prm_name VARCHAR(128) NOT NULL,
    descr BLOB SUB_TYPE TEXT,
    CONSTRAINT pk_nfn_tpl_prm_tbl PRIMARY KEY (tpl_prm_id),
...
CREATE TABLE nfn_inst_tbl (
    ...
    descr BLOB SUB_TYPE TEXT,
    fltr_expr BLOB SUB_TYPE TEXT NOT NULL,
    trgr_expr BLOB SUB_TYPE TEXT NOT NULL,
    trg_expr BLOB SUB_TYPE TEXT NOT NULL,
    ...
    obslt_utc TIMESTAMP,
    obslt_prov_id UUID,
    CONSTRAINT pk_nfn_inst_tbl PRIMARY KEY (nfn_inst_tbl),
...
CREATE TABLE nfn_inst_prm_tbl (
    ...
    expr BLOB SUB_TYPE TEXT NOT NULL,
