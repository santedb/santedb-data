...
INSERT INTO SEC_USR_TBL (USR_ID, USR_NAME, SEC_STMP, PASSWD, EMAIL, PHN_NUM, EMAIL_CNF, PHN_CNF, CRT_PROV_ID)
	VALUES (char_to_uuid('db67a3c1-c7bc-4e21-8f6c-b1c19a7f2c50'), 'Administrator', '6c351600-9fc3-408b-9d55-428a4d29361b', '59ff5973691ff75f8baa45f1e38fae24875f77ef00987ed22b02df075fb144f9', 'administrator@santedb.org', '1-800-EXAMPLE', TRUE, TRUE, char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
--#!
...
--#!
INSERT INTO SEC_USR_TBL (USR_ID, USR_NAME, SEC_STMP, PASSWD, EMAIL, PHN_NUM, EMAIL_CNF, PHN_CNF, CRT_PROV_ID)
	VALUES (char_to_uuid('28e0b42d-2be3-4139-803b-67ac68756275'), 'Bob', 'dc50d0b3-bc02-45b6-8b87-0b6f3c18acd6', '59ff5973691ff75f8baa45f1e38fae24875f77ef00987ed22b02df075fb144f9', 'bob@santedb.org', 'tel:+19055751212;ext=4085', TRUE, TRUE, char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
--#!
INSERT INTO SEC_USR_ROL_ASSOC_TBL (USR_ID, ROL_ID)
	SELECT USR_ID, ROL_ID FROM SEC_USR_TBL, SEC_ROL_TBL 
...
--#!
INSERT INTO SEC_USR_TBL (USR_ID, USR_NAME, SEC_STMP, PASSWD, EMAIL, PHN_NUM, EMAIL_CNF, PHN_CNF, CRT_PROV_ID)
	VALUES (char_to_uuid('0bfbc6bc-ab38-45a6-8d8b-201776fe4e53'), 'Allison', 'a7ec2ec7-ecde-4ea6-ac24-bf6d032cd90c', '59ff5973691ff75f8baa45f1e38fae24875f77ef00987ed22b02df075fb144f9', 'allison@santedb.org', 'tel:+19055751212;ext=4085', TRUE, TRUE, char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
--#!
INSERT INTO SEC_USR_ROL_ASSOC_TBL (USR_ID, ROL_ID)
	SELECT USR_ID, ROL_ID FROM SEC_USR_TBL, SEC_ROL_TBL 
