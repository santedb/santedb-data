/** 
 * <feature scope="SanteDB.Persistence.Data" id="20230413-01" name="Update:20230413-01" applyRange="1.1.0.0-1.2.0.0"  invariantName="sqlite">
 *	<summary>Update: Adds datamart metadata tables</summary>
 *	<isInstalled>select count(*) > 0 from patch_db_systbl WHERE PATCH_ID = '20230413-01'</isInstalled>
 * </feature>
 */
 
CREATE TABLE BI_DM_REG_SYSTBL (
	DM_ID BLOB(16) DEFAULT (RANDOMBLOB(16)) NOT NULL, 
	...
	UPD_UTC BIGINT, -- TIME THAT WAS UPDATED
	UPD_PROV_ID BLOB(16), -- USER WHICH UPDATED
...
CREATE UNIQUE INDEX UQ_BI_DM_REG_PUB_IDX ON BI_DM_REG_SYSTBL(PUB_ID) WHERE OBSLT_UTC IS NULL;

CREATE TABLE BI_DM_EXE_SYSTBL (
	EXE_ID BLOB(16) DEFAULT (RANDOMBLOB(16)) NOT NULL,
	DM_ID BLOB(16) NOT NULL,
	START_UTC BIGINT DEFAULT (UNIXEPOCH()) NOT NULL,
	TYP_CS INT NOT NULL, 
...
CREATE TABLE BI_DM_LOG_SYSTBL (
	LOG_ID BLOB(16) DEFAULT (RANDOMBLOB(16)) NOT NULL, 
	EXE_ID BLOB(16) NOT NULL,
	PRI_CS INT NOT NULL,
	UTC BIGINT DEFAULT (UNIXEPOCH()) NOT NULL,
	TXT TEXT NOT NULL,
...
INSERT INTO PATCH_DB_SYSTBL (PATCH_ID, APPLY_DATE, INFO_NAME) VALUES ('20230413-01', UNIXEPOCH(), 'ADD DATAMART METADATA'); 