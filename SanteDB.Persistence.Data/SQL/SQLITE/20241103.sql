...
INSERT OR IGNORE INTO CD_TBL (CD_ID) VALUES (x'D88140D30A74E2489E4BE418CFE174FF');
INSERT OR IGNORE INTO CD_VRSN_TBL (CD_ID, CRT_PROV_ID, STS_CD_ID, CLS_ID, MNEMONIC, HEAD) VALUES 
...
INSERT OR IGNORE INTO ACT_TBL (ACT_ID) 
	SELECT DISTINCT ENT_ID FROM MDM_TRANSITION_CACT_VW;
--#!

INSERT OR IGNORE INTO ACT_VRSN_TBL (ACT_ID, CRT_PROV_ID, ACT_UTC, TYP_CD_ID, CLS_CD_ID, MOD_CD_ID, STS_CD_ID, HEAD)
