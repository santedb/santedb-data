...
DELETE FROM ENT_POL_ASSOC_TBL WHERE SEC_POL_INST_ID IN (SELECT MAX(SEC_POL_INST_ID) FROM ENT_POL_ASSOC_TBL GROUP BY ENT_ID, POL_ID HAVING COUNT(SEC_POL_INST_ID) > 1);
DELETE FROM ENT_POL_ASSOC_TBL WHERE SEC_POL_INST_ID IN (SELECT MAX(SEC_POL_INST_ID) FROM ENT_POL_ASSOC_TBL GROUP BY ENT_ID, POL_ID HAVING COUNT(SEC_POL_INST_ID) > 1);
DELETE FROM ENT_POL_ASSOC_TBL WHERE SEC_POL_INST_ID IN (SELECT MAX(SEC_POL_INST_ID) FROM ENT_POL_ASSOC_TBL GROUP BY ENT_ID, POL_ID HAVING COUNT(SEC_POL_INST_ID) > 1);
DELETE FROM ENT_POL_ASSOC_TBL WHERE SEC_POL_INST_ID IN (SELECT MAX(SEC_POL_INST_ID) FROM ENT_POL_ASSOC_TBL GROUP BY ENT_ID, POL_ID HAVING COUNT(SEC_POL_INST_ID) > 1);
DELETE FROM ENT_POL_ASSOC_TBL WHERE SEC_POL_INST_ID IN (SELECT MAX(SEC_POL_INST_ID) FROM ENT_POL_ASSOC_TBL GROUP BY ENT_ID, POL_ID HAVING COUNT(SEC_POL_INST_ID) > 1);
