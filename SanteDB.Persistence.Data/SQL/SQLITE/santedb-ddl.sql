...
CREATE TABLE CD_VRSN_TBL (
	...
	VRSN_SEQ_ID INTEGER,-- VERSION SEQUENCE
...
CREATE UNIQUE INDEX CD_VRSN_SEQ_ID_UQ_IDX ON CD_VRSN_TBL(VRSN_SEQ_ID);
...
CREATE TABLE ACT_VRSN_TBL (
	...
	VRSN_SEQ_ID INTEGER, -- THE VERSION SEQUENCE
...
CREATE UNIQUE INDEX ACT_VRSN_SEQ_ID_UQ_IDX ON ACT_VRSN_TBL(VRSN_SEQ_ID);
...
CREATE TABLE ENT_VRSN_TBL (
	...
	VRSN_SEQ_ID INTEGER, -- UNIQUE VERSION SEQUENCE FOR THE ENTITY VERSION
...
CREATE UNIQUE INDEX ENT_VRSN_SEQ_ID_UQ_IDX ON ENT_VRSN_TBL(VRSN_SEQ_ID);
...
CREATE TABLE ENT_ADDR_CMP_TBL (
	...
	SEQ_ID INTEGER, -- THE CHAR(16) FOR THE ADDRESS VALUE
...
CREATE TABLE ENT_NAME_CMP_TBL (
	...
	SEQ_ID INTEGER, -- THE PHONETIC CODE FOR THE NAME
