...
CREATE UNIQUE INDEX CD_VRSN_SEQ_ID_UQ_IDX ON CD_VRSN_TBL(VRSN_SEQ_ID) WHERE OBSLT_UTC IS NULL;
-- HACK FOR SQLITE
...
CREATE UNIQUE INDEX ACT_VRSN_SEQ_ID_UQ_IDX ON ACT_VRSN_TBL(VRSN_SEQ_ID) WHERE OBSLT_UTC IS NULL;
...
CREATE UNIQUE INDEX ENT_VRSN_SEQ_ID_UQ_IDX ON ENT_VRSN_TBL(VRSN_SEQ_ID) WHERE OBSLT_UTC IS NULL;
