...
INSERT INTO SEC_ROL_POL_ASSOC_TBL (SEC_POL_INST_ID, POL_ID, ROL_ID, POL_ACT)  VALUES (randomblob(16), x'AA91A8FE4D22594881B3C1EB2750067E', x'58D8DBDAC513A344AD7D1C44CECAA4B6', 0); -- GRANT Read Metadata


-- CREATE SYNCHRONIZERS ROLE
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_PROV_ID) VALUES (x'7C67B7542B685F42A9373AA03D5951F1', 'APPLICATIONS', 'Group for user APPLICATIONS. Identifies the functions that are used for synchronization. EDITING THIS ROLE MAY INTRODUCE SECURITY BREACHES', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8');
...
-- CREATE DEVICE ROLE
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_PROV_ID) VALUES (x'A0053D610DDD1645A30CE733741885F0', 'DEVICE', 'Represents a device in the system. Identifies the functions that are used for devices. EDITING THIS ROLE MAY INTRODUCE SECURITY BREACHES', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8');
...
CREATE TABLE SEC_SES_TBL (
	...
	RFRSH_EXP_UTC BIGINT NOT NULL, -- THE TIME THAT THE REFRESH TOKEN EXPIRES
