/** 
 * <feature scope="SanteDB.Persistence.Data" id="20240210" name="Update:Removes unique constraint from the versioning tables for clients (allowing for sync)" applyRange="0.2.0.0-0.9.0.0" environment="Client Gateway Debugger" invariantName="sqlite">
