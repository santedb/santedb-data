/** 
 * <feature scope="SanteDB.Persistence.Data" id="20240104-02" name="Update:20240104-02" applyRange="1.1.0.0-1.2.0.0"  invariantName="sqlite">
 *	<summary>Update: Adds persistence of data quality rules in the primary database</summary>
 *	<isInstalled>select count(*) > 0 from patch_db_systbl WHERE PATCH_ID = '20240104-02'</isInstalled>
 * </feature>
 */
 --#!
 -- OPTIONAL
...
INSERT INTO PATCH_DB_SYSTBL (PATCH_ID, APPLY_DATE, INFO_NAME) VALUES ('20240104-02', UNIXEPOCH(), 'Adds DQ storage tables to database'); 
