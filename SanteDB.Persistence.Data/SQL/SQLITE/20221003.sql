...
INSERT INTO CD_TBL VALUES (x'40A745ACC7B0254484D8B3F8A41FEF9F'); --#!
INSERT INTO CD_SET_MEM_ASSOC_TBL (CD_ID, SET_ID) VALUES (x'40A745ACC7B0254484D8B3F8A41FEF9F', x'4BAF855260E0B74199D9FD8237E5AECF');--#!
 INSERT INTO CD_SET_MEM_ASSOC_TBL (CD_ID, SET_ID) VALUES (x'40A745ACC7B0254484D8B3F8A41FEF9F', x'67A616EE85200A44B1E74032D10B9F40');--#!
INSERT INTO CD_VRSN_TBL (CD_ID, STS_CD_ID, CRT_PROV_ID, MNEMONIC, CLS_ID) VALUES (x'40A745ACC7B0254484D8B3F8A41FEF9F', x'BD4C06C806FA3045B4301A52F1530C27', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8', 'Instance', x'5452FD17258CBB4AB246083FBE9AFA15');--#!
INSERT INTO REF_TERM_TBL (REF_TERM_ID, CS_ID, MNEMONIC, CRT_PROV_ID)  VALUES(x'2BF630982F734F43BE24DD5FF96C4ED3',x'7BD712FF5D627A498794C3726942B113','INST', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8');--#!
INSERT INTO CD_REF_TERM_ASSOC_TBL (REF_TERM_ID, CD_ID, EFFT_VRSN_SEQ_ID, REL_TYP_ID) SELECT x'2BF630982F734F43BE24DD5FF96C4ED3', x'40A745ACC7B0254484D8B3F8A41FEF9F', VRSN_SEQ_ID, x'C2AF4D2C6A56AE419EBC3097D7D22F4A' FROM CD_VRSN_TBL WHERE CD_ID = x'40A745ACC7B0254484D8B3F8A41FEF9F' AND OBSLT_UTC IS NULL;--#!
INSERT INTO REF_TERM_NAME_TBL (REF_TERM_ID, LANG_CS, TERM_NAME, CRT_PROV_ID) VALUES (x'2BF630982F734F43BE24DD5FF96C4ED3', 'en', 'instance', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8');--#!
INSERT INTO CD_NAME_TBL (CD_ID, EFFT_VRSN_SEQ_ID, LANG_CS, VAL) SELECT x'40A745ACC7B0254484D8B3F8A41FEF9F', VRSN_SEQ_ID, 'en', 'instance' FROM CD_VRSN_TBL WHERE CD_ID = x'40A745ACC7B0254484D8B3F8A41FEF9F' AND OBSLT_UTC IS NULL;--#!

-- FIX FOR INSTANCE CODE TYPE
INSERT INTO CD_TBL VALUES (x'D373624F2382184E8596C718AD029DEB');--#!
INSERT INTO CD_SET_MEM_ASSOC_TBL (CD_ID, SET_ID) VALUES (x'D373624F2382184E8596C718AD029DEB', x'4BAF855260E0B74199D9FD8237E5AECF');--#!
INSERT INTO CD_SET_MEM_ASSOC_TBL (CD_ID, SET_ID) VALUES (x'D373624F2382184E8596C718AD029DEB', x'67A616EE85200A44B1E74032D10B9F40');--#!
INSERT INTO CD_VRSN_TBL (CD_ID, STS_CD_ID, CRT_PROV_ID, MNEMONIC, CLS_ID) VALUES (x'D373624F2382184E8596C718AD029DEB', x'BD4C06C806FA3045B4301A52F1530C27',x'76A0DCFA90366E4AAF9EF1CD68E8C7E8', 'LocatedEntity', x'5452FD17258CBB4AB246083FBE9AFA15');--#!
INSERT INTO REF_TERM_TBL (REF_TERM_ID, CS_ID, MNEMONIC, CRT_PROV_ID)  VALUES(x'2BF6D07A2F734F43BE24DD5FF96C4ED3',x'7BD712FF5D627A498794C3726942B113','LOCE', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8');--#!
INSERT INTO CD_REF_TERM_ASSOC_TBL (REF_TERM_ID, CD_ID, EFFT_VRSN_SEQ_ID, REL_TYP_ID) SELECT x'2BF6D07A2F734F43BE24DD5FF96C4ED3', x'D373624F2382184E8596C718AD029DEB', VRSN_SEQ_ID, x'C2AF4D2C6A56AE419EBC3097D7D22F4A' FROM CD_VRSN_TBL WHERE CD_ID = x'D373624F2382184E8596C718AD029DEB' AND OBSLT_UTC IS NULL;--#!
INSERT INTO REF_TERM_NAME_TBL (REF_TERM_ID, LANG_CS, TERM_NAME, CRT_PROV_ID) VALUES (x'2BF6D07A2F734F43BE24DD5FF96C4ED3', 'en', 'located entity', x'76A0DCFA90366E4AAF9EF1CD68E8C7E8');--#!
INSERT INTO CD_NAME_TBL (CD_ID, EFFT_VRSN_SEQ_ID, LANG_CS, VAL) SELECT x'D373624F2382184E8596C718AD029DEB', VRSN_SEQ_ID, 'en', 'located entity' FROM CD_VRSN_TBL WHERE CD_ID = x'D373624F2382184E8596C718AD029DEB' AND OBSLT_UTC IS NULL;--#!
