...
UPDATE ENT_VRSN_TBL SET CLS_CD_ID = (x'7DEEEF6EF5DFD346A6A7171EF93879C7') WHERE CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5');
INSERT INTO REL_VRFY_SYSTBL (rel_vrfy_id, rel_typ_cd_id, src_cls_cd_id, trg_cls_cd_id, err_desc) 
SELECT (randomblob(16)), rel_typ_cd_id, CASE WHEN SRC_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5') THEN (x'7DEEEF6EF5DFD346A6A7171EF93879C7') ELSE SRC_CLS_CD_ID END,
CASE WHEN TRG_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5') THEN (x'7DEEEF6EF5DFD346A6A7171EF93879C7') ELSE TRG_CLS_CD_ID END, err_desc
FROM REL_VRFY_SYSTBL
WHERE SRC_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5') OR TRG_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5')
AND NOT EXISTS (SELECT 1 FROM REL_VRFY_SYSTBL D WHERE 
	D.SRC_CLS_CD_ID = CASE WHEN SRC_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5') THEN (x'7DEEEF6EF5DFD346A6A7171EF93879C7') ELSE SRC_CLS_CD_ID END
	AND D.TRG_CLS_CD_ID = CASE WHEN TRG_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5') THEN (x'7DEEEF6EF5DFD346A6A7171EF93879C7') ELSE TRG_CLS_CD_ID END 
	AND D.REL_TYP_CD_ID = REL_TYP_CD_ID)
	;
DELETE FROM REL_VRFY_SYSTBL WHERE SRC_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5') OR TRG_CLS_CD_ID = (x'569D48D9ACDD9645B5C68F41D73D8DC5');