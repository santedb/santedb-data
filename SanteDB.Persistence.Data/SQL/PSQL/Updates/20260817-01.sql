 ...
 */
 ...
 DROP MATERIALIZED VIEW IF EXISTS ORG_SANTEMPI_BI_QUERY_PATIENTS;
 DROP MATERIALIZED VIEW IF EXISTS org_santempi_bi_query_matches_demographics;
 DROP MATERIALIZED VIEW IF EXISTS org_santempi_bi_query_matches_full;
