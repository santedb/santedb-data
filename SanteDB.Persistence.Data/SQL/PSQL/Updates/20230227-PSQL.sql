...
AND NOT EXISTS (SELECT 1 FROM REL_VRFY_SYSTBL D WHERE 
	D.SRC_CLS_CD_ID = CASE WHEN SRC_CLS_CD_ID = ('d9489d56-ddac-4596-b5c6-8f41d73d8dc5') THEN ('6eefee7d-dff5-46d3-a6a7-171ef93879c7') ELSE SRC_CLS_CD_ID END
	AND D.TRG_CLS_CD_ID = CASE WHEN TRG_CLS_CD_ID = ('d9489d56-ddac-4596-b5c6-8f41d73d8dc5') THEN ('6eefee7d-dff5-46d3-a6a7-171ef93879c7') ELSE TRG_CLS_CD_ID END 
