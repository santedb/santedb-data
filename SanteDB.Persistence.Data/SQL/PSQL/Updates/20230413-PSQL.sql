/** 
 * <feature scope="SanteDB.Persistence.Data" id="20230413-01" name="Update:20230411-01" applyRange="1.1.0.0-1.2.0.0"  invariantName="npgsql">
 *	<summary>Update: Adds Datamart Metadata Tables</summary>
 *	<isInstalled>select ck_patch('20230413-01')</isInstalled>
 * </feature>
 */
 
CREATE TABLE BI_DM_REG_SYSTBL (
	DM_ID UUID NOT NULL DEFAULT UUID_GENERATE_V1(), 
	PUB_ID VARCHAR(128) NOT NULL,
	NAME VARCHAR(256) NOT NULL,
	DESCR TEXT,
	VER VARCHAR(24) NOT NULL,
	CRT_UTC TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL, -- THE TIME THAT THE AA WAS CREATED
	...
	UPD_UTC TIMESTAMPTZ, -- TIME THAT WAS UPDATED
...
CREATE TABLE BI_DM_EXE_SYSTBL (
	EXE_ID UUID NOT NULL DEFAULT UUID_GENERATE_V1(),
	DM_ID UUID NOT NULL,
	START_UTC TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL,
	TYP_CS INT NOT NULL, 
...
CREATE TABLE BI_DM_LOG_SYSTBL (
	...
	PRI_CS INT NOT NULL,
	UTC TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL,
	TXT TEXT NOT NULL,
