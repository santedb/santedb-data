/** 
 * <feature scope="SanteDB.Persistence.Data" id="20220530-01" name="Update:20220530-01"   invariantName="npgsql">
...
CREATE UNIQUE INDEX ASGN_AUT_TBL_UQ_IDX ON ASGN_AUT_TBL(DMN_ID, APP_ID) WHERE (OBSLT_UTC IS NULL);--#!
