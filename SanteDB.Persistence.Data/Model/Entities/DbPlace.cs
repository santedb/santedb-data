...
namespace SanteDB.Persistence.Data.Model.Entities
{
    ...
    public class DbPlace : DbEntitySubTable
    {
        ...
        [JoinFilter(PropertyName = nameof(DbEntityVersion.ClassConceptKey), Value = EntityClassKeyStrings.ZoneOrTerritory)]
        ...
        [JoinFilter(PropertyName = nameof(DbEntityVersion.ClassConceptKey), Value = EntityClassKeyStrings.StateOrProvince)]
