    ...
    public class NarrativeTest : DataPersistenceTest
    {
        ...
        public void TestL1WithProper()
        {
            using (AuthenticationContext.EnterSystemContext())
            {
                ...
                var narrative = Narrative.DocumentFromStream("A Sample Document", "en", "application/pdf", typeof(NarrativeTest).Assembly.GetManifestResourceStream("SanteDB.Persistence.Data.Test.SQLite.example.pdf"));
