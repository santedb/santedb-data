    ...
    public class PlacePersistenceTest : DataPersistenceTest
    {
        ...
        public void TestInsertServices()
        {
            using (AuthenticationContext.EnterSystemContext())
            {
                ...
                // Test querying 
                var afterQuery = base.TestQuery<Place>(o => o.Services.Any(s => s.ServiceConceptKey == service1), 5).AsResultSet().First();
                Assert.AreEqual(5, afterQuery.LoadProperty(o => o.Services).Count);
