    ...
    public class BundlePersistenceTest : DataPersistenceTest
    {
        ...
        public void TestMixedBatchMode()
        {
            using (AuthenticationContext.EnterSystemContext())
            {
                ...
                Assert.AreEqual(1, afterInsert.Item.Count(o => o.BatchOperation == BatchOperationType.Delete));
                Assert.AreEqual(1, afterInsert.Item.Count(o => o.BatchOperation == BatchOperationType.Update));
